package com.genesis.genesisexamsystem.question.adapter;
...
//                listener.onItemClick(v, myViewHolder.getPosition());
    ...
    private void setInitialAnswer() {
        ...
        for (int i = 0; i < questionList.size(); i++) {
            ...
            String exam_question_id = questionList.get(i).getExam_question_id();
            ...
            String skipped = "";
            String not_answered = "";
            Answer ans1 = new Answer(questionId, exam_question_id, questionSl, questionType, correct_ans_sba, correct_ans_a, correct_ans_b, correct_ans_c, correct_ans_d, correct_ans_e, skipped, not_answered);
...
//       ///
//       radio_a_1.setChecked(position == mSelectedItem);
//       radio_a_2.setChecked(position == mSelectedItem);
//       radio_b_1.setChecked(position == mSelectedItem);
//       radio_b_2.setChecked(position == mSelectedItem);
//       radio_c_1.setChecked(position == mSelectedItem);
//       radio_c_2.setChecked(position == mSelectedItem);
//       radio_d_1.setChecked(position == mSelectedItem);
//       radio_d_2.setChecked(position == mSelectedItem);
//       radio_e_1.setChecked(position == mSelectedItem);
//       radio_e_2.setChecked(position == mSelectedItem);
//       radio1.setChecked(position == mSelectedItem);
//       radio2.setChecked(position == mSelectedItem);
//       radio3.setChecked(position == mSelectedItem);
//       radio4.setChecked(position == mSelectedItem);
//       radio5.setChecked(position == mSelectedItem);
//       ///
...
//        Answer answer = answerList.get(position);
        ...
        tv_question.setText(Html.fromHtml(question.getQuestion().replaceAll("<p>", "").trim(), Html.FROM_HTML_MODE_LEGACY));
//        tv_question.setText(Html.fromHtml(question.getQuestion(), Html.FROM_HTML_MODE_LEGACY));
//        tv_question.loadData(question.getQuestion(), "text/html", "UTF-8");

//        Spanned option_1_Html = Html.fromHtml(question.getOption1());


//        tv_option1.setText(question.getOption1());
        tv_option1.setText(Html.fromHtml(question.getOption1().replaceAll("<P>", "").trim(), Html.FROM_HTML_MODE_LEGACY));
        tv_option2.setText(Html.fromHtml(question.getOption2().replaceAll("<P>", "").trim(), Html.FROM_HTML_MODE_LEGACY));
        tv_option3.setText(Html.fromHtml(question.getOption3().replaceAll("<P>", "").trim(), Html.FROM_HTML_MODE_LEGACY));
        tv_option4.setText(Html.fromHtml(question.getOption4().replaceAll("<P>", "").trim(), Html.FROM_HTML_MODE_LEGACY));
        tv_option5.setText(Html.fromHtml(question.getOption5().replaceAll("<P>", "").trim(), Html.FROM_HTML_MODE_LEGACY));
...
//
        tv_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String exam_question_id = question.getExam_question_id();
                String questionSl = String.valueOf(position + 1);
                String questionType = question.getQuestionType();
                String skipped = "";
                String not_answered = "";

                dbHelper.updateSpecificAnswer(questionId, exam_question_id, questionSl, questionType, correct_ans_sba, correct_ans_a, correct_ans_b, correct_ans_c, correct_ans_d, correct_ans_e, skipped, not_answered);
