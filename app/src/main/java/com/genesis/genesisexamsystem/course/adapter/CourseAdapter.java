package com.genesis.genesisexamsystem.course.adapter;
...
import com.genesis.genesisexamsystem.exam.ExamActivity;
...
//        String title_code = title_code_list.get(position);
        ...
        tv_title1.setText(courseModel.getId().toString());
