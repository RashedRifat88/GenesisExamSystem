...
public class CorrectAnswerAdapter extends RecyclerView.Adapter<CorrectAnswerAdapter.CorrectAnswerViewHolder> {
    ...
    public CorrectAnswerAdapter(Context context, Cursor cursor) {
        dataCursor = cursor;
        this.context = context;
...
//    questionList, answerList
    ...
    public void setData2(List<Question> questionList, List<Answer> answerList) {
    ...
    public CorrectAnswerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.single_item_correct_ans_list, parent, false);
...
//                listener.onItemClick(v, myViewHolder.getPosition());
    ...
    @Override
    public void onBindViewHolder(final CorrectAnswerAdapter.CorrectAnswerViewHolder holder, int position) {
        ...
        LinearLayout linear_multiple_choice_a_correct = holder.linear_multiple_choice_a_correct;
        LinearLayout linear_multiple_choice_b_correct = holder.linear_multiple_choice_b_correct;
        LinearLayout linear_multiple_choice_c_correct = holder.linear_multiple_choice_c_correct;
        LinearLayout linear_multiple_choice_d_correct = holder.linear_multiple_choice_d_correct;
        LinearLayout linear_multiple_choice_e_correct = holder.linear_multiple_choice_e_correct;
        ...
        RadioButton radio_a_1_correct = holder.radio_a_1_correct;
        RadioButton radio_a_2_correct = holder.radio_a_2_correct;
        RadioButton radio_b_1_correct = holder.radio_b_1_correct;
        RadioButton radio_b_2_correct = holder.radio_b_2_correct;
        RadioButton radio_c_1_correct = holder.radio_c_1_correct;
        RadioButton radio_c_2_correct = holder.radio_c_2_correct;
        RadioButton radio_d_1_correct = holder.radio_d_1_correct;
        RadioButton radio_d_2_correct = holder.radio_d_2_correct;
        RadioButton radio_e_1_correct = holder.radio_e_1_correct;
        RadioButton radio_e_2_correct = holder.radio_e_2_correct;
        RadioButton radio1_correct = holder.radio1_correct;
        RadioButton radio2_correct = holder.radio2_correct;
        RadioButton radio3_correct = holder.radio3_correct;
        RadioButton radio4_correct = holder.radio4_correct;
        RadioButton radio5_correct = holder.radio5_correct;
