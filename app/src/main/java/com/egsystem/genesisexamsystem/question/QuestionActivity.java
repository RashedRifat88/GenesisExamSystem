...
//                showSolution();
        ...
        tv_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!answered) {
//                    Toast.makeText(QuestionActivity.this, "Please select an answer or press skip to avoid", Toast.LENGTH_SHORT).show();
...
//                if (answered) {
//                    Toast.makeText(QuestionActivity.this, "Can not be skipped, you have already given answer.", Toast.LENGTH_SHORT).show();
////                    answered = true;
//
//                } else {
//                    answered = false;
